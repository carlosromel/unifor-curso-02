...
create table tb_estado (
  ...
  , constraint tb_estado_id_pais_fk   foreign key (id_pais) references tb_pais (id_pais)
...
create table tb_municipio (
  ...
  , constraint tb_municipio_id_estado_fk         foreign key (id_estado) references tb_estado (id_estado)
...
create table tb_endereco (
  ...
  , constraint tb_endereco_cd_uf_fk       foreign key (id_estado) references tb_estado (id_estado)
);
...
create table tb_cep (
  ...
  , constraint tb_cep_id_municipio_fk foreign key (id_municipio) references tb_municipio (id_municipio)
);
...
create table tb_bloqueio_usuario (
  ...
  , constraint tb_bloqueio_usuario_id_usuario_fk          foreign key (id_usuario) references tb_usuario(id_usuario)
);
...
create table tb_usuario_localizacao (
  ...
  , constraint tb_usuario_localizacao_id_usuario                foreign key (id_localizacao) references tb_localizacao (id_localizacao)
);
...
create table tb_processo_instance (
 ...
 * Fluxo.
 */
create table tb_tipo_processo_documento (
...
create table tb_processo_documento (
  ...
  , constraint tb_processo_documento_id_processo_fk           foreign key (id_processo) references tb_processo (id_processo)
);

create table tb_processo_documento_bin (
  ...
  , constraint tb_processo_documento_bin_id_processo_documento_fk     foreign key (id_processo_documento) references tb_processo_documento (id_processo_documento)
);
 ...
 * Documentos.
 */
create table tb_grupo_modelo_documento (
...
create table tb_tipo_modelo_documento (
...
create table tb_modelo_documento (
  ...
  , constraint tb_modelo_documento_id_tipo_modelo_documento_fk foreign key (id_tipo_modelo_documento) references tb_tipo_modelo_documento (id_tipo_modelo_documento)
);
...
create table tb_documento_historico (
...
create table tb_tipo_proc_doc_papel (
  ...
  , constraint tb_tipo_proc_doc_papel_id_tipo_modelo_documento_fk       foreign key (id_tipo_modelo_documento) references tb_tipo_modelo_documento (id_tipo_modelo_documento)
);

/**
 * Movimentação em lote.
 */
create table tb_hist_movimentacao_lote (
  ...
  , constraint tb_hist_movimentacao_lote_id_usuario_fk               foreign key (id_usuario) references tb_usuario (id_usuario)
);

create table tb_hist_proc_moviment_lote (
  ...
  , constraint tb_hist_proc_moviment_lote_id_processo_trf_fk            foreign key (id_processo_trf)            references tb_processo_trf (id_processo_trf)
  , constraint tb_hist_proc_moviment_lote_id_transicao_fk               foreign key (id_transicao)               references tb_processo_transicao (id_transicao)
  , constraint tb_hist_proc_moviment_lote_id_process_instance_origem_fk foreign key (id_process_instance_origem) references tb_process_instance (id_process_instance)
  , constraint tb_hist_proc_moviment_lote_id_task_instance_origem_fk    foreign key (id_task_instance_origem)    references tb_task_instance (id_task_instance)
  , constraint tb_hist_proc_moviment_lote_id_task_origem_fk             foreign key (id_task_origem)             references tb_task_instance (id_task_instance)
);

/**
 * JBPM.
 */
create table tb_jbpm_variavel_label (
...
create table tb_log_detalhe (
  ...
  , constraint tb_log_detalhe_id_log_fk         foreign key (id_log) references tb_log (id_log)
);
...
create table tb_pesquisa_campo (
  ...
  , constraint tb_pesquisa_campo_id_pesquisa_fk       foreign key (id_pesquisa) references tb_pesquisa (id_pesquisa)
);

/**
 * Eventos.
 */
create table tb_evento_agrupamento (
...
create table tb_variavel_fluxo (
...
create table tb_variavel_tipo_modelo (
  ...
  , constraint tb_variavel_tipo_modelo_id_variavel_fk              foreign key (id_variavel)              references tb_variavel (id_variavel)
  , constraint tb_variavel_tipo_modelo_id_tipo_modelo_documento_fk foreign key (id_tipo_modelo_documento) references tb_tipo_modelo_documento (id_tipo_modelo_documento)
);
...
create table tb_tarefa_evento (
  ...
  , constraint tb_tarefa_id_tarefa_fk               foreign key (id_tarefa) references tb_tarefa (id_tarefa)
);

create table tb_tarefa_jbpm (
    id_tarefa_jbpm                  bigserial    not null
  , id_tarefa                       bigint       not null

  , constraint tb_tarefa_jbpm_id_tarefa_jbpm_pk primary key (id_tarefa_jbpm)
  , constraint tb_tarefa_jbpm_id_tarefa_fv      foreign key (id_tarefa) references tb_tarefa (id_tarefa)
);

create table tb_tarefa_transicao_evento (
  ...
  , constraint tb_tarefa_transmissao_evento_id_tarefa_fk                    foreign key (id_tarefa) references tb_tarefa (id_tarefa)
);

create table tb_processo_tarefa_evento (
  ...
  , constraint tb_processo_tarefaid_processo                      foreign key (id_processo)      references tb_processo (id_processo)
  , constraint tb_processo_tarefa_id_tarefa_evento_fk             foreign key (id_tarefa_evento) references tb_tarefa_evento (id_tarefa_evento)
);
...
create table tb_historico_ajuda (
 ...
 * Tabelas avulsas.
 */
create table tb_item_tipo_documento (
    id_item_tipo_documento          bigserial    not null
);

create table tb_lista_email (
    id_lista_email                  bigserial    not null
);

create table tb_proc_localizacao_ibpm (
    id_processo_localizacao         bigserial    not null
);

create table tb_processo_conexao (
    dt_processo_conexao             timestamp    default (now())
);

create table tb_documento_certidao (
...
create table tb_tipo_modelo_doc_papel (
    id_tipo_modelo_documento_papel  bigserial    not null
);

create table tb_tarefa_trans_even_agrupamento (
